    ...
    def get_closest(self, point: Coordinate, egg: Egg) -> Ball:
        ...
        for target in self.targets:
            ...
            if in_obstacle(self.obstacle, target.center):
                ...
                clips = robot_collides(self.obstacle, egg, point, best_driving_point, int(self.pixel_per_cm))
                ...
                clips = robot_collides(self.obstacle, egg, point, target.center, pixel_per_cm=int(self.pixel_per_cm))
